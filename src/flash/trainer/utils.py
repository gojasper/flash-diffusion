...
class StateDictRenamer:
    ...
    Example:
        ...
        new_state_dict = renamer(
            checkpoint_state_dict=state_dict,
            rename_dict={
                "add_embedding.linear_1.bias": "class_embedding.linear_1.weight",
                "add_embedding.linear_1.weight": "class_embedding.linear_1.bias",
                "add_embedding.linear_2.bias": "class_embedding.linear_2.weight",
                "add_embedding.linear_2.weight": "class_embedding.linear_2.bias",
            }
        )
        ```
